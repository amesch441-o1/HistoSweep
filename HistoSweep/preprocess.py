...
def get_args():
    ...
    # Include these for compatibility (even if unused here)
...
def main():
    ...
    print(f"Saving preprocessed image to: {output_dir}/he.tiff")
    smart_save_image_vips(img, os.path.join(output_dir, ""), base_name="he", size_threshold=10000)
