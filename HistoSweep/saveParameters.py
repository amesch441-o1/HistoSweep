...
def saveParams(prefix, output, need_scaling_flag, need_preprocessing_flag,
               pixel_size_raw, density_thresh, clean_background_flag, min_size,
               patch_size, pixel_size):

    # Output file path (output is already the full directory path)
    output_dir = output
